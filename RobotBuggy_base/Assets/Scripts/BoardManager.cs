...
namespace Completed
{
    public class BoardManager : Singleton<BoardManager>
    {
        ...
        public void SetupScene()
        {
            ...
            //Instantiate a set number of keys, at randomized positions.
            LayoutObjectAtRandom(foodTiles, key, key);

            //there will always only be one enemy
            int enemyCount = 1;

            //Instantiate the enemy at a random location
